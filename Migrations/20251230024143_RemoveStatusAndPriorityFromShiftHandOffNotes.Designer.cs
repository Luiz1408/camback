...
namespace ExcelProcessorApi.Migrations
{
    ...
    [Migration("20251230024143_RemoveStatusAndPriorityFromShiftHandOffNotes")]
    partial class RemoveStatusAndPriorityFromShiftHandOffNotes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ExcelProcessorApi.Models.ShiftHandOffNote", b =>
                {
                    ...
                    b.Property<int?>("DeliveringUserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ExcelProcessorApi.Models.ShiftHandOffNote", b =>
                {
                    ...
                    b.HasOne("ExcelProcessorApi.Models.User", "DeliveringUser")
                        .WithMany()
                        .HasForeignKey("DeliveringUserId");
